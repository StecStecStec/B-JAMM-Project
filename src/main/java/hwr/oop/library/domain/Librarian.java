...
public class Librarian {
  ...
  public static Librarian createNewLibrarian(
      Library library, String librarianName, String librarianSurname, String librarianBirthday) {
    return new Librarian(
        library, UUID.randomUUID(), librarianName, librarianSurname, librarianBirthday);
  }

  public static Librarian createCompleteNewLibrarian(
      Library library,
      UUID uuid,
      String librarianName,
      String librarianSurname,
      String librarianBirthday) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(librarianID, librarian.librarianID)
        ...
        && Objects.equals(librarianBirthday, librarian.librarianBirthday);
  }
