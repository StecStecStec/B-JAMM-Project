...
public class Visitor {
  ...
  public static Visitor createCompleteVisitor(
      Library library,
      String visitorName,
      String visitorSurname,
      String visitorBirthday,
      ...
      UUID uuid) {
    return new Visitor(
        library, visitorName, visitorSurname, visitorBirthday, visitorEmailAddress, uuid);
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(visitorID, visitor.visitorID)
        ...
        && Objects.equals(visitorSurname, visitor.visitorSurname)
        && Objects.equals(visitorBirthday, visitor.visitorBirthday)
        && Objects.equals(visitorEmailAddress, visitor.visitorEmailAddress)
        && Objects.equals(borrowedBooks, visitor.borrowedBooks)
        && Objects.equals(booksToReturn, visitor.booksToReturn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(
        visitorID, visitorName, visitorSurname, visitorBirthday, visitorEmailAddress);
  }
}
