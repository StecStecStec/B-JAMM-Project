...
class EqualsHashTest {
  ...
  void book_testEqualsMethod() {
    ...
    assertThat(book1).isEqualTo(book1).isNotEqualTo(book3).isNotNull();
  ...
  void visitor_testEqualsMethod() {
    ...
    Visitor visitor1 =
        Visitor.createCompleteVisitor(
            library, "John", "Doe", "1990-01-01", "john.doe@example.com", uuid1);
    Visitor visitor2 =
        Visitor.createCompleteVisitor(
            library, "John", "Doe", "1990-01-01", "john.doe@example.com", uuid1);
    Visitor visitor3 =
        Visitor.createNewVisitor(library, "Jane", "Doe", "1990-01-01", "jane.doe@example.com");

    assertThat(visitor1).isEqualTo(visitor1).isNotEqualTo(visitor3).isNotNull();
  ...
  void shelf_testEqualsMethod() {
    ...
    assertThat(shelf1).isEqualTo(shelf1).isNotEqualTo(shelf3).isNotNull();
  ...
  void room_testEqualsMethod() {
    ...
    Visitor visitor =
        Visitor.createNewVisitor(library, "John", "Doe", "1990-01-01", "john.doe@example.com");
    ...
    assertThat(room1).isEqualTo(room1).isNotEqualTo(room3).isNotNull();
  ...
  void librarian_testEqualsMethod() {
    ...
    Librarian librarian1 =
        Librarian.createCompleteNewLibrarian(library, uuid, "John", "Doe", "1990-01-01");
    Librarian librarian2 =
        Librarian.createCompleteNewLibrarian(library, uuid, "John", "Doe", "1990-01-01");
    Librarian librarian3 = Librarian.createNewLibrarian(library, "John", "Doe", "1990-01-01");

    assertThat(librarian1).isEqualTo(librarian1).isNotEqualTo(librarian3).isNotNull();
  ...
  void library_testEqualsMethod() {
    ...
    assertThat(library).isEqualTo(library).isNotEqualTo(library2).isNotNull();
